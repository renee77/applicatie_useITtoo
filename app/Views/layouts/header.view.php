...
<body>
    <header>
        <div class="header container">
            ...
            <div id="login">
                <!-- Wrapper rond het login-icoon en dropdown, zodat de dropdown relatief hieraan gepositioneerd kan worden -->
                <div class="login-wrapper">
                    ...
                    <?php if ($session->isLoggedIn()): ?>
                        ...
                        <div class="login-dropdown">
                            ...
                            <!-- htmlspecialchars voorkomt XSS: tekens zoals < > " worden omgezet naar HTML-entiteiten -->
                ...
                <img src="<?= BASE_URL ?>/assets/images/clickables/winkelwagen-lichtgroen.png" id="winkelwagenLogo" alt="winkelwagen logo">
            </div>
        </div>
